  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'radial-gradient(at 40% 20%, hsla(228,97%,70%,0.3) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(280,97%,70%,0.2) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(228,97%,70%,0.2) 0px, transparent 50%), radial-gradient(at 80% 50%, hsla(280,97%,70%,0.15) 0px, transparent 50%), radial-gradient(at 0% 100%, hsla(228,97%,70%,0.2) 0px, transparent 50%)',
      },
      boxShadow: {
        ...
        'card-hover': '0 20px 40px -10px rgba(99, 102, 241, 0.15), 0 8px 16px -8px rgba(0, 0, 0, 0.1)',
